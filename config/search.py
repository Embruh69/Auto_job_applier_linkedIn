...
search_terms = ["Data Analyst Intern", "Junior Data Analyst", "Data Science Intern", "Business Intelligence Analyst", "Data Visualization Analyst", "Data Management Intern"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Indonesia"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "5+ years", "10+ years", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
