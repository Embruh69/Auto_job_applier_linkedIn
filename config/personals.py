...
# Your legal name
first_name = "Leonard"             # Your first name in quotes Eg: "First", "Sai"
middle_name = "Aldo"                # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Suhendri"              # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "081311208478"      # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "West Jakarta"      # Los Angeles, San Francisco, etc.
'''
