...
username = "leonard.aldo123@gmail.com"       # Enter your username in the quotes
password = "Bruhmoment1699"           # Enter your password in the quotes
...
llm_api_key = "sk-46a4a012bb1d4985a481dce71bcbc988"              # Enter your API key in the quotes, make sure it's valid, if not will result in error.
'''
...
llm_model = "deepseek-llm:latest"          # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct", "qwen3:latest", "gemini-pro", "gemini-1.5-flash", "gemini-2.5-flash", "deepseek-llm:latest"
